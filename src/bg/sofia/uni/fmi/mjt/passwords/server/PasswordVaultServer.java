...
import bg.sofia.uni.fmi.mjt.passwords.server.user.repository.adapter.UserRepositoryBinaryFileAdapter;
import bg.sofia.uni.fmi.mjt.passwords.server.user.repository.adapter.UserRepositoryFileAdapter;
...
public class PasswordVaultServer {
    ...
    private static final String SERVER_STOP = "Server is stopped. Data is saved.";
    ...
    private final UserRepositoryFileAdapter fileAdapter;
    private final CommandExecutor commandExecutor;

    public PasswordVaultServer(int port) {
        this.port = port;
        this.userRepository = InMemoryUserRepository.getInstance();
        this.fileAdapter = new UserRepositoryBinaryFileAdapter();
